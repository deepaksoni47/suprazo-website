...
const internshipTracks = [
  {
    ...
    duration: "3-6 months",
    description:
      "Learn React, Next.js, and modern frontend technologies while working on real projects.",
  ...
  },
  {
    ...
    duration: "3-6 months",
    description:
      "Build mobile applications using React Native and Flutter with mentorship from senior developers.",
  ...
  },
  {
    ...
    duration: "4-6 months",
    description:
      "Work on machine learning projects and gain hands-on experience with AI technologies.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {internshipTracks.map((track, index) => (
            <Card
              key={index}
              className="glass-card border-0 transition-all duration-300 hover:scale-[1.02] group"
            >
              <CardContent className="p-6">
                <div className="flex items-center space-x-3 mb-4">
                  <div
                    className={`w-3 h-3 bg-gradient-to-r ${track.color} rounded-full`}
                  />
        ...
        <Card className="glass-card border-0">
          <CardContent className="p-8 md:p-12 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              ...
              with cutting-edge technologies while working alongside industry
              experts.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                size="lg"
                className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 text-lg font-semibold group transition-all duration-300 hover:scale-105"
              >
                Apply Now
              ...
              <Button
                size="lg"
                variant="outline"
                className="glass border-2 border-blue-400 text-blue-400 hover:bg-blue-500 hover:text-white px-8 py-4 text-lg font-semibold transition-all duration-300 hover:scale-105 bg-transparent"
              >
                Learn More
              </Button>
            </div>
